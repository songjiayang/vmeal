...
class Qq
        APPID='100331819'
        APPKEY='599c75c1746543cb18ec3f4a500d2e9e'
        REDURL='&redirect_uri=www.weidaxue.me'
        ...
        #同步分享到QQ空间、朋友网、腾讯微博
        def add_share(auth,title,url,comment,summary,images,site,fromurl)
            data=auth + '&title=' + title + '&url=' + url + '&comment=' + comment + '&summary=' + summary + '&images=' + images + '&site=' + site + '&fromurl=' + fromurl
